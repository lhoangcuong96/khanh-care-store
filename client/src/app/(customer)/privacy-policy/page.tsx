          ...
          <main className="flex-grow">
            <div className="space-y-6">
              <section>
                ...
                <p className="mb-4">
                  Khi bạn sử dụng ứng dụng của chúng tôi, chúng tôi có thể thu
                  thập các thông tin sau:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li>Thông tin bạn cung cấp khi tạo tài khoản</li>
                  <li>
                    Thông tin từ Facebook khi bạn đăng nhập bằng Facebook (bao
                    gồm địa chỉ email và thông tin hồ sơ công khai)
                  </li>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Cung cấp cho bạn quyền truy cập vào dịch vụ của chúng tôi
                  </li>
              ...
              <section>
                ...
                <p className="mb-4">
                  ...
                  thông tin cá nhân của bạn. Tuy nhiên, không có phương thức
                  truyền tải nào qua internet là an toàn 100%, và chúng tôi
              ...
              <section>
                ...
                <p className="mb-4">
                  ...
                  bằng cách đăng Chính sách bảo mật mới trên trang này và cập
