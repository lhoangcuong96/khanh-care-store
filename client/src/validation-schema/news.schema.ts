...
export const NewsSchema = z.object({
  ...
  title: z
    .string()
    .min(1, "Tiêu đề là thông tin bắt buộc")
    .max(256, "Tiêu đề không được quá 256 kí tự"),
  slug: z.string().min(1).max(256),
  summary: z
    .string()
    .min(1, "Tóm tắt là thông tin bắt buộc")
    .max(500, "Tóm tắt không được quá 500 kí tự"),
