...
const PartnerSchema = z.object({
  ...
  name: z
    .string()
    .min(1, "Tên là thông tin bắt buộc")
    .max(255, "Tên không được quá 255 kí tự"),
  phone: z
    .string()
    .regex(
  ...
  type: z
    .enum(Object.values(PartnerType) as [PartnerType, ...PartnerType[]])
    .default(PartnerType.INDIVIDUAL),
  status: z.enum(["ACTIVE", "INACTIVE"]).default("ACTIVE"),
  notes: z
    .string()
    .max(255, "Ghi chú không được quá 255 kí tự")
    .optional()
    .nullable(),
  totalDebt: z.number().default(0),
  paidAmount: z.number().default(0),
  remainingDebt: z.number().default(0),
  contactPerson: z
    .string()
    .max(255, "Người liên hệ không được quá 255 kí tự")
    .optional()
    .nullable(),
  contactPosition: z
    .string()
    .max(255, "Chức vụ không được quá 255 kí tự")
    .optional()
    .nullable(),
  contactPhone: z
    .string()
...
export type CreatePartnerResponseType = z.infer<
...
export type GetListPartnerParamsType = z.infer<
  typeof GetListPartnerParamsSchema
>;
export type GetListPartnerResponseType = z.infer<
  typeof GetListPartnerResponseSchema
>;
...
export type GetListPartnerOptionResponseType = z.infer<
  typeof GetListPartnerOptionResponseSchema
>;
...
export const TransactionItemSchema = z.object({
  ...
  quantity: z
    .number()
    .min(1, "Số lượng là thông tin bắt buộc")
    .max(1000, "Số lượng không được quá 1000"),
  price: z
    .number()
    .min(1, "Giá là thông tin bắt buộc")
    .max(1000000000, "Giá không được quá 1 tỷ"),
  total: z
    .number()
    .min(1, "Thành tiền là thông tin bắt buộc")
    .max(1000000000, "Thành tiền không được quá 1 tỷ"),
  notes: z
    .string()
    .max(255, "Ghi chú không được quá 255 kí tự")
    .optional()
...
export type AddTransactionResponseType = z.infer<
  typeof AddTransactionResponseSchema
>;
/* Transaction */
